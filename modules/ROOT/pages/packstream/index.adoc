...
Even though the unsigned 32-bit integer following `D3` could hold a bigger number, the maximum byte size of strings limited to 2 147 483 647 (maximum value of a signed 32-bit integer).
