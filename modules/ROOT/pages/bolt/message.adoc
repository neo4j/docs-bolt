...
* `gql_status::String` - the gql status which identifies the error. This should be used in favor of `neo4j_code`. See more about GQL Status here. label:new[Introduced in bolt 5.7]
...
** `_classification::String?` - classifies the failure. See more details about classifications here.
