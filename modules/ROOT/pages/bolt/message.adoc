...
put in the servers metric system. The client will receive a `Success` in response unless it sends an invalid entry to the api field in which case the client will receive a `FAILURE`.
