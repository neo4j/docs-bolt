...
label:deprecated[Removed after bolt 5.8]
* `message::String` - the human readable description of the failure.
This message is intended for debugging or display purposes.
Format and content are not guaranteed to remain stable.
