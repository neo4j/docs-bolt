...
The server state transitions are using the updated set of messages defined in xref:bolt/message/#_version_4_0[Bolt Protocol Message Specification Version 4.0].
...
The server state transitions are using the updated set of messages defined in xref:bolt/message/#_version_3[Bolt Protocol Message Specification Version 3].
