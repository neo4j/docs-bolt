...
With Bolt version 4.0 the version scheme now supports major and minor versioning number.
...
With Bolt version 4.3, the version scheme now supports ranges of minor versions.
